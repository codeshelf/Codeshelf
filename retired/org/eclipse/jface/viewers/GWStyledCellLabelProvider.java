 ...
 * @since 3.4
 */
public abstract class GWStyledCellLabelProvider extends OwnerDrawLabelProvider {
	 ...
	 */
	public GWStyledCellLabelProvider() {
		this(0);
	}
	 ...
	 */
	public GWStyledCellLabelProvider(int style) {
	 ...
	 */
	public int updateTextLayout(TextLayout layout, ViewerCell cell,
			boolean applyColors) {
