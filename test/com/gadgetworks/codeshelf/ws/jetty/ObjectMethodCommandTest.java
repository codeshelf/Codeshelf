...
public class ObjectMethodCommandTest {
	...
	public final void testCreateFacilityOK() {
		...
		Facility.setDao(facDao);
		DropboxService.setDao(dropboxDao);
		IronMqService.setDao(ironMqDao);
		CodeshelfNetwork.setDao(netDao);
		ContainerKind.setDao(containerKindDao);
		Che.setDao(cheDao);
