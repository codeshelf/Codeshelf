...
public class AisleImporterTest extends MockDaoTest {
	...
	public final void testTierB1S1Side() {
		...
		Facility facility = Facility.createFacility(getDefaultTenant(),"F-AISLE9", "TEST", Point.getZeroPoint());
		...
		Aisle aisle2 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A9");
		...
		Bay bayA9B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle2, "B2");
		Assert.assertNotNull(bayA9B2);

		Bay bayA9B2x = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle, "B2");
		Assert.assertNotNull(bayA9B2x);

		// Testing how well findByDomainId works. Both bay1 and bay2 have T2 tiers.
		Tier tierB1T2 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bay1, "T2");
		Assert.assertNotNull(tierB1T2);

		Tier tierB2T2 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bay2, "T2");
		...
		Slot slotB1T2S3 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T2, "S3");
		Assert.assertNotNull(slotB1T2S3);

		Slot slotB2T2S3 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB2T2, "S3");
		...
		Tier tierB1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bay1, "T1");
		Assert.assertNotNull(tierB1T2);
		Tier tierB2T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bay2, "T1");
		...
		Slot slotB1T1S1 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T1, "S1");
		...
		Slot slotB1T1S8 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T1, "S8");
	...
	public final void testTierNotB1S1Side() {
		...
		Facility facility = Facility.createFacility(getDefaultTenant(),"F-AISLE10", "TEST", Point.getZeroPoint());
		...
		// Check what we got
		Aisle aisle = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A10");
		Assert.assertNotNull(aisle);
		...
		Bay bayA10B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle, "B1");
		Bay bayA10B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle, "B2");

		id = bayA10B1.getLocationIdToParentLevel(Aisle.class);
		Assert.assertTrue(id.equals("A10.B1"));

		Tier tierB1T2 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA10B1, "T2");
		Tier tierB2T2 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA10B2, "T2");
		Tier tierB1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA10B1, "T1");
		Tier tierB2T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA10B2, "T1");
		...
		Slot slotB1T1S6 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T1, "S6");
		...
		Slot slotB2T1S1 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB2T1, "S1");
		...
		Aisle aisle20 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A20");
		Assert.assertNotNull(aisle20);
		Bay bayA20B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle20, "B1");
		Assert.assertNotNull(bayA20B1);
		Tier tierA20B1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA20B1, "T1");
	...
	public final void test32Led5Slot() {
		...
		Facility facility = Facility.createFacility(getDefaultTenant(),"F-AISLE11", "TEST", Point.getZeroPoint());
		...
		Bay bayA11B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle, "B1");

		Tier tierB1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA11B1, "T1");

		Slot slotB1T1S1 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T1, "S1");
		Slot slotB1T1S2 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T1, "S2");
		Slot slotB1T1S3 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T1, "S3");
		Slot slotB1T1S4 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T1, "S4");
		Slot slotB1T1S5 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T1, "S5");
		...
		Bay bayA11B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle, "B2");
		Tier tierB2T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA11B2, "T1");

		Slot slotB2T1S1 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB2T1, "S1");
		Slot slotB2T1S2 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB2T1, "S2");
		Slot slotB2T1S9 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB2T1, "S9");
		Slot slotB2T1S10 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB2T1, "S10");
		Slot slotB2T1S11 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB2T1, "S11");
		...
		// check the bay sort
		Bay bayA11B3 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle, "B3");
		Tier tierB3T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA11B3, "T1");
		...
		Bay bayA11B10 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle, "B10");
		Tier tierB10T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA11B10, "T1");
	...
	public final void testSparseLeds() {
		...
		Facility facility = Facility.createFacility(getDefaultTenant(),"F-SPARSE91", "TEST", Point.getZeroPoint());
		...
		Bay bayA91B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle, "B1");

		Tier tierB1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA91B1, "T1");
		Tier tierB1T2 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA91B1, "T2");
		Tier tierB1T3 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA91B1, "T3");
		Tier tierB1T4 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA91B1, "T4");
		Tier tierB1T5 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA91B1, "T5");
		...
		Slot slotB1T5S1 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T5, "S1");
		Slot slotB1T5S2 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T5, "S2");
		Slot slotB1T5S3 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T5, "S3");
		Slot slotB1T5S4 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T5, "S4");
		Slot slotB1T5S5 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T5, "S5");
	...
	public final void testZigzagB1S1Side() {
		...
		Facility facility = Facility.createFacility(getDefaultTenant(),"F-AISLE12", "TEST", Point.getZeroPoint());
		...
		Bay bayA12B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle, "B1");
		Bay bayA12B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle, "B2");

		Tier tierB1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA12B1, "T1");
		Tier tierB2T2 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA12B2, "T2");

		Slot slotB1T1S1 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T1, "S1");

		Slot slotB2T2S5 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB2T2, "S5");
		...
		Tier tierB1T3 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA12B1, "T3");
		Tier tierB2T3 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA12B2, "T3");
	...
	public final void testZigzagNotB1S1Side() {
		...
		Facility facility = Facility.createFacility(getDefaultTenant(),"F-AISLE13", "TEST", Point.getZeroPoint());
		...
		Bay bayA13B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle, "B1");
		Bay bayA13B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle, "B2");

		Tier tierB1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA13B1, "T1");
		Tier tierB2T2 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA13B2, "T2");
		...
		Tier tierB1T3 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA13B1, "T3");
		Tier tierB2T3 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA13B2, "T3");
		short tierB1T3First = tierB1T3.getFirstLedNumAlongPath();
	...
	public final void testMultiAisleZig() {
		...
		Facility facility = Facility.createFacility(getDefaultTenant(),"F-AISLE2X", "TEST", Point.getZeroPoint());
		...
		Bay bayA21B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle, "B1");
		Bay bayA21B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle, "B2");

		// For 2 bays, 2 tier, zigzagB1S1Side, tierB1T2 should start at led 1. tierB2T2 should start at 65
		Tier tierB1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA21B1, "T1");
		Tier tierB1T2 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA21B1, "T2");
		Tier tierB2T2 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA21B2, "T2");
		...
		Aisle aisle22 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A22");
		Assert.assertNotNull(aisle);
		Bay bayA22B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle22, "B1");
		Tier tierA22B1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA22B1, "T1");
	...
	public final void testBadFile1() {
		...
		Facility facility = Facility.createFacility(getDefaultTenant(),"F-AISLE14", "TEST", Point.getZeroPoint());
		...
		Bay bayA14B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle, "B2");
		Assert.assertNull(bayA14B2); // bay should have failed for the tier coming first.

		Bay bayA14B3 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle, "B3");
		Assert.assertNull(bayA14B3); // bay should have failed for nothing read until next aisle.

		Aisle aisle7 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A7");
		Assert.assertNotNull(aisle7); // the aisle started ok. Note that we do not enforce name number consistency on aisles

		Bay bayA7B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle7, "B1");
		Assert.assertNotNull(bayA7B1); // bay should be ok

		Tier tierB1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA7B1, "T1");
		Assert.assertNotNull(tierB1T1); // should be there

		Bay bayA7B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle7, "B2");
		Assert.assertNull(bayA7B2); // will not be there because second T1 in B1 made it skip past rest of this aisle

		Aisle aisleB7 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "AB7");
		Assert.assertNull(aisleB7); // the aisle name not accepted

		Aisle aisle9 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A9");
		Assert.assertNotNull(aisle9); // ok

		Bay bayA9B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle9, "B1");
		...
		Bay A51B12 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),A512, "B1");
		Assert.assertNotNull(A51B12);
		
		Tier tierA51B1T12 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),A51B12, "T1");
		Assert.assertNotNull(tierA51B1T12);
		
		Aisle A522 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A52");
	...
	public final void testDoubleFileRead() {
		...
		Facility facility = Facility.createFacility(getDefaultTenant(),"F-AISLE15", "TEST", Point.getZeroPoint());
		...
		Assert.assertNotNull(aisle);
		Bay bayA15B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle, "B1");
		Tier tierB1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA15B1, "T1");
		...
		bayA15B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle, "B1");
		Bay bayA15B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle, "B2");
		...
		tierB1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA15B1, "T1");
		Assert.assertNotNull(tierB1T1); // should still exist

		Tier tierB2T2 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA15B2, "T2");
		Assert.assertNotNull(tierB2T2); // Shows that we reread and this time created T2

		slotB1T1S1 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T1, "S1");
		...
		slotB1T1S3 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T1, "S3");
		...
		bayA15B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle3, "B1");
		bayA15B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle3, "B2");
		Assert.assertNotNull(bayA15B2); // Incorrect! We want B2 to be null or somehow retired

		tierB1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA15B1, "T1");
		Assert.assertNotNull(tierB1T1); // should still exist

		Tier tierB1T2 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA15B1, "T2");
		Assert.assertNotNull(tierB1T2); // Incorrect! We want T2 to be null or somehow retired

		slotB1T1S1 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T1, "S1");
		Assert.assertNotNull(slotB1T1S1); // should still exist
		slotB1T1S5 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T1, "S5");
	...
	public final void testAfterFileModifications() {
		...
		Facility facility = Facility.createFacility(getDefaultTenant(),"F-AISLE16", "TEST", Point.getZeroPoint());
		...
		Bay bayA16B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle16, "B1");
		Bay bayA16B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle16, "B2");
		Assert.assertNotNull(bayA16B2);

		Tier tierB1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA16B1, "T1");
		Assert.assertNotNull(tierB1T1);
		Tier tierB2T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA16B2, "T1");
		Assert.assertNotNull(tierB2T1);
		...
		tierB2T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA16B2, "T1");
		...
		tierB1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA16B1, "T1");
		Assert.assertNull(tierB1T1.getLedController());
		Assert.assertNull(tierB1T1.getLedChannel());
		Assert.assertEquals(ledController66, tierB1T1.getEffectiveLedController());
		Assert.assertTrue(tierB1T1.getEffectiveLedChannel() == 2);
		...
		aisle16 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A16");
		// Assert.assertEquals(ledController55, tierB1T1.getEffectiveLedController()); // Fails
		// There is no way in this test structure to re-get the facility from the database under a new transaction.
		// aisle16 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),getFacility(), "A16");
		// similar problem: still the old facility reference.
		tierB1T1 = (Tier) facility.findSubLocationById("A16.B1.T1");
		// Assert.assertEquals(ledController55, tierB1T1.getEffectiveLedController()); // Fails
		List<Facility> aList = Facility.staticGetDao().getAll(getDefaultTenant());
	...
	public final void testNoLed() {
		...
		Facility facility = Facility.createFacility(getDefaultTenant(),"F-AISLE21", "TEST", Point.getZeroPoint());
		...
		Bay bayA21B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle21, "B1");
		Bay bayA21B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle21, "B2");

		Tier tierB2T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA21B2, "T1");
		Tier tierB1T2 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA21B1, "T2");

		Slot slotB2T1S1 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB2T1, "S1");

		Slot slotB1T2S5 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierB1T2, "S5");
	...
	public final void testPathCreation() {
		...
		// Path aPath2 = Path.staticGetDao().findByDomainId(getDefaultTenant(),facility, "F4X.1");  does not work
	...
	public final void simplestPathTest() {
		...
		Facility facility = Facility.createFacility(getDefaultTenant(),"F-AISLE5X", "TEST", Point.getZeroPoint());
		...
		Bay bayA51B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle51, "B1");
		Tier tierA51B1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA51B1, "T1");
		Slot slotS1 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierA51B1T1, "S1");
		Assert.assertNotNull(slotS1);
		Slot slotS4 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierA51B1T1, "S4");
	...
	public final void testCloneTierB1S1Aisle(){
		...
		Aisle aisle51 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A51");
		Assert.assertNotNull(aisle51);
		Aisle aisle52 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A52");
		Assert.assertNotNull(aisle52);
		Aisle aisle53 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A53");
		Assert.assertNotNull(aisle53);
		Aisle aisle54 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A54");
		...
		Slot slotA51B1T1S4 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierA51B1T1, "S4");
		...
		Bay bayA53B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle53, "B1");
		Assert.assertNotNull(bayA53B1);
		Tier tierA53B1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA53B1, "T1");
		Assert.assertNotNull(tierA53B1T1);
		Slot slotA53B1T1S4 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierA53B1T1, "S4");
		...
		Bay bayA53B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle53, "B2");
		Assert.assertNotNull(bayA53B2);
		Tier tierA53B2T3 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA53B2, "T3");
		...
		Aisle aisle522 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A52");
		Assert.assertNotNull(aisle522);
		Aisle aisle532 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A53");
		Assert.assertNotNull(aisle532);
		Aisle aisle542 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A54");
		Assert.assertNotNull(aisle542);
		
		// Check LED values
		Bay bayA51B12 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle512, "B1");
		Assert.assertNotNull(bayA51B12);
		Tier tierA51B1T12 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA51B12, "T1");
		Assert.assertNotNull(tierA51B1T12);
		Slot slotA51B1T1S42 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierA51B1T12, "S4");
		...
		Bay bayA53B12 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle532, "B1");
		Assert.assertNotNull(bayA53B12);
		Tier tierA53B1T12 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA53B12, "T1");
		Assert.assertNotNull(tierA53B1T12);
		Slot slotA53B1T1S42 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierA53B1T12, "S4");
		...
		// Check number slots and LEDs on B2 T3
		Bay bayA53B22 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle532, "B2");
		Assert.assertNotNull(bayA53B22);
		Tier tierA53B2T32 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA53B22, "T3");
	...
	public final void testCloneTierNotB1S1Aisle(){
		...
		Facility facility = Facility.createFacility(getDefaultTenant(),"F-CLONE5X", "TEST", Point.getZeroPoint());
	...
	public final void testCloneZigzagNotB1S1Aisle(){
		...
		Bay bayA51B22 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle512, "B2");
		Assert.assertNotNull(bayA51B22);
		Tier tierA51B2T32 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA51B22, "T3");
	...
	public final void testCloneChangeAttributes(){
		...
		Vertex V3 = Vertex.staticGetDao().findByDomainId(getDefaultTenant(),aisle512, "V03");
	...
	public final void testCloneAisle() {
		...
		Bay bayA52B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle52, "B1");
		Assert.assertNotNull(bayA52B1); // change to notNull with DEV-618
		
		
		// curious. Tier.staticGetDao().findByDomainId(getDefaultTenant(),null, "T1"); will find the A51 T1
		Tier tierA52B1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA52B1, "T1");
		Assert.assertNotNull(tierA52B1T1);
		Slot slot52S1 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierA52B1T1, "S1");
		Assert.assertNotNull(slot52S1);
		Slot slot52S4 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierA52B1T1, "S4");
		...
		// Get A52
		Aisle aisle523 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A52");
		Assert.assertNotNull(aisle523);
		
		// Get A53
		Aisle aisle533 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A53");
		...
		// Get A52
		Aisle aisle524 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A52");
		Assert.assertNotNull(aisle524);
		
		// Get A53
		Aisle aisle534 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A53");
		Assert.assertNotNull(aisle534);
		
		// Get A53
		Aisle aisle544 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A54");
	...
	public final void testBadCloneAisle2() {
		...
		Bay A51B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),A51, "B1");
		Assert.assertNotNull(A51B1);
		
		Bay A51B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),A51, "B2");
		Assert.assertNull(A51B2);
		
		Bay A51B3 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),A51, "B3");
		...
		Aisle A532 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A53");
	...
	public final void testCloneAisleSlotCount() {
		...
		Tier tierA51B1T2 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA51B1, "T2");
		...
		// Aisle 51 - Bay 1 - Tier 2
		Tier tierA52B1T2 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA52B1, "T2");
	...
	public final void testCloneBay() {
		...
		Bay bayA51B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle51, "B2");
		Assert.assertNotNull(bayA51B2);
		
		Tier tierA51B2T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA51B2, "T1");
		Assert.assertNotNull(tierA51B2T1);
		
		Tier tierA51B2T2 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA51B2, "T2");
		Assert.assertNotNull(tierA51B2T2);

		// Check if the third bay exists and its tiers
		Bay bayA51B3 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle51, "B3");
		Assert.assertNotNull(bayA51B3);
		
		Tier tierA51B3T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA51B3, "T1");
		Assert.assertNotNull(tierA51B3T1);
		
		Tier tierA51B3T2 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA51B3, "T2");
		...
		// Check if the second bay exists and its tiers
		Bay bayA52B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle52, "B2");
		Assert.assertNotNull(bayA52B2);
		
		Tier tierA52B2T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA52B2, "T1");
		Assert.assertNotNull(tierA52B2T1);
		
		Tier tierA52B2T2 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA52B2, "T2");
		Assert.assertNotNull(tierA52B2T2);

		// Check if the third bay exists and its tiers
		Bay bayA52B3 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle52, "B3");
		Assert.assertNotNull(bayA52B3);
		
		Tier tierA52B3T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA52B3, "T1");
		Assert.assertNotNull(tierA52B3T1);
		
		Tier tierA52B3T2 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA52B3, "T2");
	...
	public final void testBadCloneBay() {
		...
		Bay bayA51B4 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle51, "B4");
		...
		Bay A512B3 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisleA512, "B3");
	...
	public final void testCloneBayOrderings() {
		...
		Aisle aisleA52 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A52");
		Assert.assertNotNull(aisleA52);
		
		// Check the bays exist
		Bay bayA51B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisleA51, "B1");
		Assert.assertNotNull(bayA51B1);
		
		Bay bayA51B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisleA51, "B2");
		Assert.assertNotNull(bayA51B2);
		
		Bay bayA51B3 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisleA51, "B3");
		Assert.assertNotNull(bayA51B3);
		
		Bay bayA51B4 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisleA51, "B4");
		Assert.assertNotNull(bayA51B4);
		
		Bay bayA52B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisleA52, "B1");
		Assert.assertNotNull(bayA52B1);
		
		Bay bayA52B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisleA52, "B2");
		Assert.assertNotNull(bayA52B2);
		
		Bay bayA52B3 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisleA52, "B3");
		Assert.assertNotNull(bayA52B3);
		
		Bay bayA52B4 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisleA52, "B4");
		...
		Bay bayA51B22 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisleA512, "B2");
		Assert.assertNotNull(bayA51B22);
		
		Bay bayA51B32 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisleA512, "B3");
		Assert.assertNotNull(bayA51B32);
		
		// Check tiers of aisles
		Tier tierA51B2T12 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA51B22, "T1");
		Assert.assertNotNull(tierA51B2T12);
		
		Tier tierA51B2T22 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA51B22, "T2");
		Assert.assertNotNull(tierA51B2T22);
		
		Tier tierA51B3T12 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA51B32, "T1");
		Assert.assertNotNull(tierA51B3T12);
		
		Tier tierA51B3T22 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA51B32, "T2");
	...
	public final void testPath() {
		...
		Facility facility = Facility.createFacility(getDefaultTenant(),"F3X", "TEST", Point.getZeroPoint());
		...
		Bay bayA31B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle31, "B1");
		Bay bayA31B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle31, "B2");

		// For 2 bays, 2 tier, zigzagB1S1Side, tierB1T2 should start at led 1. tierB2T2 should start at 65
		Tier tierA31B1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA31B1, "T1");
		Tier tierA31B2T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA31B2, "T1");

		// Get A32
		Aisle aisle32 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A32");
		Assert.assertNotNull(aisle32);
		Bay bayA32B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle32, "B1");
		Bay bayA32B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle32, "B2");
		Tier tierA32B1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA32B1, "T1");
		Tier tierA32B2T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA32B2, "T1");
		...
		Slot firstA32SlotOnPath = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierA32B2T1, "S5");

		Short lowestLEDforA32 = firstA32SlotOnPath.getFirstLedNumAlongPath();
		Assert.assertTrue(lowestLEDforA32 < 4);
		Slot lowestA31LedSLot = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierA31B1T1, "S1");
		...
		tierA31B1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA31B1, "T1");
		tierA31B2T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA31B2, "T1");
		tierA32B1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA32B1, "T1");
		tierA32B2T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA32B2, "T1");
		...
		Slot slotA31B1T1S1 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierA31B1T1, "S1");
		Slot slotA31B1T1S5 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierA31B1T1, "S5");
		Slot slotA31B2T1S1 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierA31B2T1, "S1");
		Slot slotA31B2T1S5 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierA31B2T1, "S5");
		Slot slotA32B1T1S1 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierA32B1T1, "S1");
		Slot slotA32B1T1S5 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierA32B1T1, "S5");
		Slot slotA32B2T1S1 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierA32B2T1, "S1");
		Slot slotA32B2T1S5 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierA32B2T1, "S5");
	...
	protected void checkLocations(UUID facilityID, UUID retrievedPathID, String segmentDomainId, Aisle... locations) {
		Path retrievedPath;
		retrievedPath = Path.staticGetDao().findByPersistentId(getDefaultTenant(),retrievedPathID);
		// this segment should have one location now. However, the old reference is stale and may know its aisles (used to be). Re-get
		PathSegment retrievedSegment = PathSegment.staticGetDao().findByDomainId(getDefaultTenant(),retrievedPath, segmentDomainId);
		...
		Facility retrievedFacility = Facility.staticGetDao().findByPersistentId(getDefaultTenant(),facilityID);
	...
	public final void nonSlottedTest() {
		...
		Facility facility = Facility.createFacility(getDefaultTenant(),"F-AISLE6X", "TEST", Point.getZeroPoint());
		...
		aisle61 = Aisle.staticGetDao().findByDomainId(getDefaultTenant(),facility, "A61");
		Bay bayA61B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle61, "B1");
		Bay bayA61B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle61, "B2");
		...
		Tier tierA61B1T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA61B1, "T1");
		Assert.assertNotNull(tierA61B1T1);
		Tier tierA61B2T1 = Tier.staticGetDao().findByDomainId(getDefaultTenant(),bayA61B2, "T1");
		Assert.assertNotNull(tierA61B2T1);
		Slot slotS1 = Slot.staticGetDao().findByDomainId(getDefaultTenant(),tierA61B1T1, "S1");
	...
	public final void testMultipleReferencesForSimpleField() {
		...
		Facility facility = Facility.createFacility(getDefaultTenant(),"F-AISLE29", "TEST", Point.getZeroPoint());
		...
		Bay bayA16B1 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle29, "B1");
		Bay bayA16B2 = Bay.staticGetDao().findByDomainId(getDefaultTenant(),aisle29, "B2");
		Assert.assertNotNull(bayA16B2);
		...
		Slot.staticGetDao().store(getDefaultTenant(),slotB1T1S5);
		...
		List<Facility> listB = Facility.staticGetDao().getAll(getDefaultTenant());
		...
		Slot.staticGetDao().store(getDefaultTenant(),slotB1T1S5); // object attached to the transaction, but still not persisted
		Assert.assertTrue(slotB1T1S5.getActive());
		...
		List<Facility> listC = Facility.staticGetDao().getAll(getDefaultTenant());
		...
		List<Facility> listD = Facility.staticGetDao().getAll(getDefaultTenant());
	...
	public final void outOfOrderStores() {
		...
		Facility facility = Facility.createFacility(getDefaultTenant(),"F-AISLE31", "TEST", Point.getZeroPoint());
		...
		List<Facility> listA = Facility.staticGetDao().getAll(getDefaultTenant());
