...
import com.gadgetworks.codeshelf.web.websocket.HandshakedataImpl1;
import com.gadgetworks.codeshelf.web.websocket.WebSocket.Role;
...
public class Draft_76 extends Draft_75 {
	...
	public HandshakeState acceptHandshakeAsServer(Handshakedata handshakedata) {
		...
		if (handshakedata.getFieldValue("Upgrade").equals("WebSocket") && handshakedata.getFieldValue("Connection").contains("Upgrade")
				&& handshakedata.getFieldValue("Sec-WebSocket-Key1").length() > 0 && !handshakedata.getFieldValue("Sec-WebSocket-Key2").isEmpty() && handshakedata.hasFieldValue("Origin")
