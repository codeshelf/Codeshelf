 ...
 *  $Id: WebSessionRespCmdObjectFilter.java,v 1.2 2012/09/08 03:03:23 jeffw Exp $
 *******************************************************************************/
 ...
 *
 */
public class WebSessionRespCmdObjectFilter extends WebSessionRespCmdABC {
	 ...
	 * 
	 */
	public WebSessionRespCmdObjectFilter(final ObjectNode inResponseValue) {
		mResponseNode = inResponseValue;
	}

	public final WebSessionRespCmdEnum getCommandEnum() {
		return WebSessionRespCmdEnum.OBJECT_FILTER_RESP;
	}
