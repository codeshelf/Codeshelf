 ...
 *  $Id: ObjectFilterWsRespCmd.java,v 1.1 2013/03/17 19:19:12 jeffw Exp $
 *******************************************************************************/
 ...
 *
 */
public class ObjectFilterWsRespCmd extends WsRespCmdABC {
	 ...
	 * 
	 */
	public ObjectFilterWsRespCmd(final ObjectNode inResponseValue) {
		mResponseNode = inResponseValue;
	}

	public final WsRespCmdEnum getCommandEnum() {
		return WsRespCmdEnum.OBJECT_FILTER_RESP;
	}
