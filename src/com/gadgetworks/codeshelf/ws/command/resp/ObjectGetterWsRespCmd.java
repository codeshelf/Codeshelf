 ...
 *  $Id: ObjectGetterWsRespCmd.java,v 1.1 2013/03/17 19:19:12 jeffw Exp $
 *******************************************************************************/
 ...
 *
 */
public class ObjectGetterWsRespCmd extends WsRespCmdABC {
	 ...
	 * 
	 */
	public ObjectGetterWsRespCmd(final ObjectNode inResponseValue) {
		mResponseNode = inResponseValue;
	}

	public final WsRespCmdEnum getCommandEnum() {
		return WsRespCmdEnum.OBJECT_GETTER_RESP;
	}
