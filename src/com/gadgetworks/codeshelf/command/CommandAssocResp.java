 ...
 *  $Id: CommandAssocResp.java,v 1.3 2011/01/24 07:22:42 jeffw Exp $
 *******************************************************************************/
 ...
 *  @author jeffw
 *  
 *  The controller sends the associate response command to any device whose MacAddr is under management by this controller.  
 *  The controller maps the MacAddr string to an unused address slot in the network address table.
...
public final class CommandAssocResp extends CommandAssocABC {
	 ...
	 */
	public CommandAssocResp(final NetMacAddress inMacAddress, final NetworkId inNetworkId, final NetAddress inAddressToAssign) {
		super(CommandIdEnum.ASSOC_RESP, inMacAddress);
