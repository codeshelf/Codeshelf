...
public class CommandControlPosconSetupStop extends CommandControlABC{
	 ...
	 */
	public CommandControlPosconSetupStop(final NetEndpoint inEndpoint,
		final Byte inPosNum) {
		super(inEndpoint, new NetCommandId(CommandControlABC.POSCON_SETUP_STOP));
	 ...
	 */
	public CommandControlPosconSetupStop() {
		super(new NetCommandId(CommandControlABC.POSCON_SETUP_STOP));
	}
	...
	public String doToString() {
		return "Exit mass config mode pos: " + mPosNum;
	}
