...
public class RadioPacketHandler_v2 extends RadioPacketHandler_v1 {
	private static final Logger	LOGGER	= LoggerFactory.getLogger(RadioPacketHandler_v2.class);

	public RadioPacketHandler_v2(NetAddress mServerAddress,
